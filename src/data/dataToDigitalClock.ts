...
export const dataToDigitalClock = [
    ...
    { number: 3, digitalParts: [1, 3, 4, 6, 7] },
    { number: 4, digitalParts: [2, 3, 4, 6] },
    { number: 5, digitalParts: [1, 2, 4, 6, 7] },
    { number: 6, digitalParts: [1, 2, 4, 5, 6, 7] },
    { number: 7, digitalParts: [1, 3, 6] },
    { number: 8, digitalParts: [1, 2, 3, 4, 5, 6, 7] },
